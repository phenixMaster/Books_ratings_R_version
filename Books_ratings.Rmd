...
to buy be tempt or subject to buy a book or not. In this application we have been 
...
plot(dens_AR,frame = F,main ="density av raing")
```
...
We could normalize data to diminish the effect of magnitude in some numeric variables. 
...
- Removes some features without variation or. very low variation.
